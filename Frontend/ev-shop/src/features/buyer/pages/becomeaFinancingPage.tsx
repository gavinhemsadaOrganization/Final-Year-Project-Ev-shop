...
const RegisterFinancialInstitutionPage: React.FC<{ onClose: () => void }> = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("Submitting financial institution:", institutionData);

    try {
      // --- SIMULATED API CALL ---
      // Replace this with your actual fetch call
      // Example:
      // const response = await fetch('/api/v1/financial/register', {
      //   method: 'POST',
      //   headers: {
      ...
      console.log("API Success:", { success: true, data: institutionData });
      setSuccessMessage(
        "Your financial institution has been registered successfully!"
      );
